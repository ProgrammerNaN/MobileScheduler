package com.example.teleg.programm.MainCalendarClasses;
...
import com.example.teleg.programm.MainCalendarClasses.adapter.CalendarDataAdapter;
import com.example.teleg.programm.MainCalendarClasses.adapter.ViewPagerAdapter;
...
import com.example.teleg.programm.MainCalendarClasses.fragment.CalendarFragment;
    ...
    public void setDateSelectionData(ArrayList<EventData> dateData) {
        ...
        if (items.size() == 0) {
            ...
            try {
                ...
                mTxtEventMessage.setText(getResources().getString(R.string.no_events));
            } catch (ParseException e) {
                Log.e(TAG, e.getMessage(), e);
            }
